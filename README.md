...
1. stb\_ds (<https://github.com/nothings/stb>) - общественное достояние;

2. sds (<https://github.com/antirez/sds>) - лицензия 2-clause BSD.
...
- [ ] Немного исправить формат хранения данных о вероятностях "да/нет", чтобы
  было удобнее искать их потом

- [ ] Добавить модуль expert, который будет задавать вопросы и принимать ответы
  на них

- [ ] Реализовать считывание шифрованных файлов (там наверняка какое-то
  хиленькое шифрование)
